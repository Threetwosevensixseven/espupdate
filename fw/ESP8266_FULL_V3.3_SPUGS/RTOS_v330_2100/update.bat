...
python ..\esptool.py --chip esp8266 --port COM5 --baud 115200 --before default_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 26m --flash_size 1MB 0x0000 "RTOS_v330_2100.fac"
